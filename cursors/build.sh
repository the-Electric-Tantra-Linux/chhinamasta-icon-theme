...
THEME="Chhinamasta Cursors"
BUILD="$SRC/../dist"
create svg

THEME="Chhinamasta-white Cursors"
BUILD="$SRC/../dist-dark"
create svg-white

THEME="Chhinamasta-ubuntu Cursors"
BUILD="$SRC/../dist-ubuntu"
create ubuntu

THEME="Chhinamasta-ubuntu-white Cursors"
BUILD="$SRC/../dist-ubuntu-dark"
create ubuntu-white

THEME="Chhinamasta-manjaro Cursors"
BUILD="$SRC/../dist-manjaro"
create manjaro

THEME="Chhinamasta-manjaro-white Cursors"
